...
function openMoreInfo(){
  num = (Number(event.target.id))%5;
  if (num == 0){
    window.open("./moreInfo0.html"); // 새 창 여는 방법
  }else if (num == 1){
    window.open("./moreInfo1.html"); // 새 창 여는 방법
  }else if (num == 2){
    window.open("./moreInfo2.html"); // 새 창 여는 방법
  }else if (num == 3){
    window.open("./moreInfo3.html"); // 새 창 여는 방법
  }else if (num == 4){
    window.open("./moreInfo4.html"); // 새 창 여는 방법
  }
